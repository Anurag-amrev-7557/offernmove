document.addEventListener('DOMContentLoaded', () => {
    document.querySelector('#login').addEventListener("click", (event) => {
        event.preventDefault();
            ...
            Swal.fire({
                ...
                <div class="title_container">
                    ...
                    <span class="subtitle">Get started with our app, just login to your account and enjoy the experience.</span>
                </div>
                <span class="error-message animate__animated" id="login_error" style="font-size: 0.85rem; color: red; font-weight: 550; transition: all 0.3s ease; position: absolute; top: 8.8rem;"></span>
                <br>
                ...
                <button title="Sign In" type="submit" class="sign-in_btn">
                    ...
                    <span style="display: flex; justify-content: center;">Sign In</span>
                </button>
                ...
                <button title="Sign In" type="submit" class="sign-in_ggl g-signin2" data-onsuccess="onSignIn">
                ...
                <a class="note" href="/terms">Terms of use &amp; Conditions</a>
                <div class="login-redirect">
                    <span>New to OfferNMove? &nbsp; <span id="signup-go">Create account</span></span>
                </div>
                </form>
                `,
            ...
            willOpen: () => {
                ...
                const login = document.querySelector(".sign-in_btn");
                ...
                const loader = () => {
                    const loginSpan = login.querySelector("span");
                    if (loginSpan) {
                    ...
                    if (isValid) {
                        ...
                        try {
                            ...
                            if (data.success) {
                                ...
                                loginError.classList.add("animate__zoomIn");
        ...
        document.querySelector('.g-signin2').addEventListener('click', function(el) {
            el.preventDefault();
